...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FlowFile.total_size'
        db.alter_column(u'flowjs_flowfile', 'total_size', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'FlowFile.total_size'
        db.alter_column(u'flowjs_flowfile', 'total_size', self.gf('django.db.models.fields.IntegerField')())
