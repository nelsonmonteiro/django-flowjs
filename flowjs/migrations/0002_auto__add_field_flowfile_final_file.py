...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'flowjs_flowfile', 'final_file',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'flowjs_flowfile', 'final_file')
    ...
    models = {
        u'flowjs.flowfile': {
            ...
            'final_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
